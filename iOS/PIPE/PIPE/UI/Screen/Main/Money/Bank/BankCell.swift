...
class BankDepositSavingCell: UITableViewCell {
...
//        self.addGestureRecognizer(tapGestureRecognizer)
    ...
    func bind(model: DepositSavingModel) {
        nameLabel.text = model.fin_prdt_nm
        rewardLabel.text = "DepositSavingModel: \(model.fin_prdt_nm)"
        descriptionLabel.text = "\(model.optionList)"
    }
