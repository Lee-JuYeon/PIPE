...
class EmploymentController : UIViewController, CustomModulerUIDelegate {
...
//    private var employmentList : [EmploymentModel] = [] {
//        didSet {
//            // homeList가 업데이트될 때마다 화면 갱신
//            customModulerView.updateList(newList: self.employmentList)
//        }
//    }
//    private func initList(){
//        jobVM?.futureEmployment(delivery: { future in
//            future.sink { <#Subscribers.Completion<Never>#> in
//                <#code#>
//            } receiveValue: { <#[EmploymentModel]#> in
//                <#code#>
//            }
//
//        })
//        jobVM?.employmentList.sink(receiveCompletion: { completion in
//            <#code#>
//        }, receiveValue: { list in
//            <#code#>
//        })
//
//        jobVM?.loadEmploymentList()
//    }
